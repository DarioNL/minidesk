                        ...
                        <div class="row">
                            ...
                            <div class="row col-12">
                                <div class="col-6">
                                    ...
                                    <input id="vat_number" type="text" class="form-control  @error('vat_number') is-invalid @enderror" maxlength="9" name="vat_number" value="{{ $company->vat_number }}" required autofocus autocomplete="vat_number">
