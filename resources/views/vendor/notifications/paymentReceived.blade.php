    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:570px;">
        <tr>
            <td align="center"
                ...
                <h2 style="font-size: 30px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;">
                    Hello {{$invoice->client->first_name}} {{$invoice->client->last_name}} Your Payment has been received!
                </h2>
            </td>
        </tr>
        <tr>
            <td align="center"
                ...
                <p style="font-size: 16px; font-weight: 400; line-height: 24px; color: #777777;">
                    Thank you for the payment of €{{$invoice->total}}
                    for the invoice @if($invoice->title != null){{$invoice->title}}@else{{$invoice->nummber}}@endif.
                </p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left"
                ...
                <p style="font-size: 16px; font-weight: 400; line-height: 24px; color: #777777;">
                    You can download the order below.<br><br> Regards,<br> Minidesk
                </p>
            </td>
        </tr>
    </table>
